...
class AdSpaceUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'spaceName' => [
                ...
                'string',
                'max:50',
                Rule::unique('app_ad_space', 'space_name')
                    ->whereNull('deleted_at')
                    ->ignore($spaceId, 'space_id'),
            ],
            'spaceCode' => [
                'required',
                'string',
                'max:50',
                Rule::unique('app_ad_space', 'space_code')
                    ->whereNull('deleted_at')
                    ->ignore($spaceId, 'space_id'),
            ],
