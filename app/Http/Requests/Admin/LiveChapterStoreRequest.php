...
class LiveChapterStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'liveRoomId'     => 'required|string|max:50',
    ...
    public function messages()
    {
        return [
            ...
            'chapterStartTime.date' => '章节开始时间格式无效',
            'chapterEndTime.required' => '章节结束时间不能为空',
            'chapterEndTime.date' => '章节结束时间格式无效',
            'chapterEndTime.after' => '章节结束时间必须晚于章节开始时间',
            'liveRoomId.required'     => '直播间ID不能为空',
