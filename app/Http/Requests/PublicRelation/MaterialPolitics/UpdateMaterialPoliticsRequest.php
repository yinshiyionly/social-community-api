...
class UpdateMaterialPoliticsRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'province_code' => 'nullable|integer|min:0',
            'city_code' => 'nullable|integer|min:0',
            'district_code' => 'nullable|integer|min:0',
