 ...
 * 诽谤类投诉邮件发送历史记录模型
 *
 * 用于记录每次诽谤类投诉邮件发送的详细信息，包括收件人、操作人、邮件数据和渲染后的HTML内容
 *
 * @property int $id 主键ID
 * @property int $complaint_id 关联的诽谤类投诉记录ID
 ...
 * @property-read ComplaintDefamation|null $complaint 关联的诽谤类投诉记录
 */
class ComplaintDefamationSendHistory extends Model
{
    // ==================== 发送状态常量 ====================
     ...
     * @var string
     */
    protected $table = 'complaint_defamation_send_history';
     ...
     * 关联诽谤类投诉记录
     *
     * @return BelongsTo<ComplaintDefamation, ComplaintDefamationSendHistory>
     */
    public function complaint(): BelongsTo
    {
        return $this->belongsTo(ComplaintDefamation::class, 'complaint_id', 'id');
    }
}
