 ...
 * 企业投诉邮件发送历史记录模型
 *
 * 用于记录每次企业投诉邮件发送的详细信息，包括收件人、操作人、邮件数据和渲染后的HTML内容
 *
 * @property int $id 主键ID
 * @property int $complaint_id 关联的企业投诉记录ID
 ...
 * @property-read ComplaintEnterprise|null $complaint 关联的企业投诉记录
 */
class ComplaintEnterpriseSendHistory extends Model
{
    // ==================== 发送状态常量 ====================
     ...
     * @var string
     */
    protected $table = 'complaint_enterprise_send_history';
     ...
     * 关联企业投诉记录
     *
     * @return BelongsTo<ComplaintEnterprise, ComplaintEnterpriseSendHistory>
     */
    public function complaint(): BelongsTo
    {
        return $this->belongsTo(ComplaintEnterprise::class, 'complaint_id', 'id');
    }
}
